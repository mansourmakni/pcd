...
<p><a href="<%= userService.createLoginURL("/") %> " ><span class="btn btn-large btn-success">Login</span></a></p>
<% }
else { %>
	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> Electro</a>
				<ul>
				<li><a class="active" href="products.jsp"><i class="icon-chevron-right"></i>Réfrigérateur</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Lavage</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Cuisson</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Chaud/Froid</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Petit déjeuner</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Bien être</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>Soins maison</a></li>
				</ul>
			</li>
